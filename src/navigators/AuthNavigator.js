...
import HomeSceneRegistry from '../screens/Onboarding/HomeSceneRegistry';
...
function AuthStackScreen() {
  return (
    ...
    >
      ...
      <AuthStack.Screen name='CommunitySetup' component={ HomeSceneRegistry } options={ () => ({ headerTitle: 'Join Your Home Scene' }) } />
