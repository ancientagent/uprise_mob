...
UPRISE quick links
- Carryover Template: [docs/SPRINT2_CARRYOVER_TEMPLATE.md](../SPRINT2_CARRYOVER_TEMPLATE.md)
- Execution Plan: [docs/PHASE2_EXECUTION_PLAN.md](../PHASE2_EXECUTION_PLAN.md)
