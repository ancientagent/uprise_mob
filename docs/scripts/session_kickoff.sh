...
sed -n '1,160p' docs/architecture/SYSTEM_OVERVIEW.md || true
sed -n '1,160p' docs/PHASE2_EXECUTION_PLAN.md || true
chmod +x docs/scripts/phase2_smoke.sh || true
COMMUNITY_KEY="${COMMUNITY_KEY:-austin-texas-hip-hop}" BASE_URL="$API_BASE_URL" ./docs/scripts/phase2_smoke.sh || true
